              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                  <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">
                    Beds Allocated Manage
                  </h2>
                  <p className="mt-1 text-gray-500 dark:text-gray-300">
                    List All Bed Allocated
                  </p>
                </div>
                {/* Add New Bed Button */}
                <Link
                  to="/admin/bed/allocated/add"
                  ...
                  {(data || []).map((bedAllocated, index) => {
                    return (
                      ...
                      >
                        ...
                        <td className="whitespace-nowrap px-6 py-4">
                          <div className="text-sm text-gray-900 dark:text-gray-100">
                            {bedAllocated.patient_id}
                          </div>
                        </td>
                        <td className="whitespace-nowrap px-6 py-4">
                          <div className="text-sm text-gray-900 dark:text-gray-100">
                            {bedAllocated.allocated_date}
                          </div>
                        </td>
                        <td className="whitespace-nowrap px-6 py-4">
                          <div className="text-sm text-gray-900 dark:text-gray-100">
                            {bedAllocated.discharge}
                          </div>
                        </td>
...
export default ListAllAllocatedBeds;
